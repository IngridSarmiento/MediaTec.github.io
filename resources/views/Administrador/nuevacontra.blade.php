                        ...
                        <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <form action="/editar-usuario/{{$usuario->id}}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nombre" value="{{$usuario->nombre}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="correo" class="form-label">Correo</label>
                                    <input type="email" name="correo" value="{{$usuario->correo}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="password" class="form-label">Nueva contraseña</label>
                                    <input type="password" name="password" value="{{$usuario->password}}" class="form-control" id="exampleInputPassword1">
                                </div>     
                                <div align="center">                                 
