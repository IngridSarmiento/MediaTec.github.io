    ...
    <head>
        ...
        <!-- Font Awesome icons (free version)-->
         <script src="https://use.fontawesome.com/releases/v5.15.3/js/all.js" crossorigin="anonymous"></script>
            ...
            <link rel="stylesheet" href="{{asset('mediatec/assets/css/fontawesome.css')}}">
            <link rel="stylesheet" href="{{asset('mediatec/assets/css/templatemo-edu-meeting.css')}}">
            <link rel="stylesheet" href="{{asset('mediatec/assets/css/owl.css')}}">
            <link rel="stylesheet" href="{{asset('mediatec/assets/css/lightbox.css')}}">
