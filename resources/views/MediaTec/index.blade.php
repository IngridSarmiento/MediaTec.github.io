        ...
        <section class="page-section" id="index">
            <div class="container">
                <div class="text">
                    ...
                    <img src="{{asset('mediatec/assets/img/logos/media.png')}}" width="380px" height="350px" style="margin-right: 100px" align="left">                    
                                ...
                                <div class="item">
                                    @switch($destacado->multimedias->where('principal', '1')->first()->tipo)
                                        ...
                                        @case("video")
                                            ...
                                            @break
                                        @case("audio")
                                            <audio src="{{asset($destacado->multimedias->where('principal', '1')->first()->ruta)}}" width="400px" height="300px" controls></audio>
                                            @break
                                        @case("documento")
