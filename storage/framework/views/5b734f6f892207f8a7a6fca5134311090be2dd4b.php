<?php echo $__env->make('MediaTec.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <header class="cabecera_xs" style=" background-image: url(<?php echo e(asset('mediatec/assets/img/politicas-fondo.jpg')); ?>">
        </header> 
            <section class="contacto pt-5" id="colecciones">
                <div class="container">
                    <div class="container-xxl">
                        <div class="container" align="center">
                            <h1 class="mb-4">POLÍTICA DE PRIVACIDAD PARA LA PLATAFORMA DIGITAL MEDIATEC</h1>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <p>Última actualización: 6 de febrero de 2023</p>
                        ...
                        <p>Usamos sus datos personales para proporcionar y mejorar el Servicio. Al usar el Servicio, acepta la recopilación y el uso de información de acuerdo con esta Política de privacidad. Esta Política de privacidad se ha creado con la ayuda del <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank">Generador de políticas de privacidad</a>.</p >
                        ...
                        <li>
                        <p><strong>Empresa</strong> (referida como "la Empresa", "Nosotros", "Nos" o "Nuestro" en este Acuerdo) se refiere a MEDIATEC.</p>
                        </li>
                        <li>
                        <p><strong>Cookies</strong> son pequeños archivos que un sitio web coloca en Su computadora, dispositivo móvil o cualquier otro dispositivo, y contienen los detalles de Su historial de navegación en ese sitio web entre sus muchos usos.</p>
                        </li>
                        <li>
                        ...
                        <li>
                        <p><strong>Datos de uso</strong> se refiere a los datos recopilados automáticamente, ya sea generados por el uso del Servicio o por la propia infraestructura del Servicio (por ejemplo, la duración de una visita a la página).</p>
                        </li>
                        <li>
                        <p><strong>Sitio web</strong> hace referencia a MEDIATEC, accesible desde <a href="https://mediatec-ittg.000webhostapp.com/index.php" rel="external nofollow noopener" target="_blank" >https://mediatec-ittg.000webhostapp.com/index.php</a></p>
                        </li>
                        <li>
                        ...
                        <p>Las cookies pueden ser &quot;Persistentes&quot; o &quot;Sesión&quot; Galletas. Las cookies persistentes permanecen en su computadora personal o dispositivo móvil cuando se desconecta, mientras que las cookies de sesión se eliminan tan pronto como cierra su navegador web. Obtén más información sobre las cookies en el artículo <a href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" target="_blank">Sitio web de políticas de privacidad</a>.</p >
                        <p>Utilizamos cookies de sesión y persistentes para los fines que se describen a continuación:</p>
                        <ul>
                        <li>
                        ...
                        <li>
                        <p><strong>Política de Cookies / Aviso de Cookies de Aceptación</strong></p>
                        ...
                        <p>La Empresa podrá utilizar los Datos Personales para los siguientes fines:</p>
                        <ul>
                        <li>
                        <p><strong>Para proporcionar y mantener nuestro Servicio</strong>, incluido el control del uso de nuestro Servicio.</p>
                        </li>
                        <li>
                        <p><strong>Para administrar Su Cuenta:</strong> para administrar Su registro como usuario del Servicio. Los Datos Personales que proporcione pueden darle acceso a diferentes funcionalidades del Servicio que están disponibles para Usted como usuario registrado.</p>
                        </li>
                        <li>
                        ...
                        <li>
                        <p><strong>Para contactarlo:</strong> para contactarlo por correo electrónico, llamadas telefónicas, SMS u otras formas equivalentes de comunicación electrónica, como notificaciones automáticas de una aplicación móvil con respecto a actualizaciones o comunicaciones informativas relacionadas con las funcionalidades, productos o servicios contratados, incluidas las actualizaciones de seguridad, cuando sea necesario o razonable para su implementación.</p>
                        </li>
                        <li>
                        <p><strong>Para proporcionarle</strong> noticias, ofertas especiales e información general sobre otros bienes, servicios y eventos que ofrecemos que son similares a los que ya ha comprado o sobre los que ha consultado, a menos que haya optado por no hacerlo. recibir dicha información.</p>
                        </li>
                        <li>
                        ...
                        <li><strong>Para transferencias comerciales:</strong> podemos compartir o transferir Su información personal en relación con, o durante las negociaciones de, cualquier fusión, venta de activos de la Compañía, financiamiento o adquisición de la totalidad o una parte de Nuestro negocio a otra empresa.</li>
                        ...
                        <p>La Empresa también conservará los Datos de uso para fines de análisis interno. Los Datos de uso generalmente se retienen por un período de tiempo más corto, excepto cuando estos datos se usan para fortalecer la seguridad o mejorar la funcionalidad de Nuestro Servicio, o cuando estamos legalmente obligados a retener estos datos por períodos de tiempo más largos.</p>
                        ...
                        <p>En determinadas circunstancias, es posible que se le solicite a la Empresa que divulgue Sus Datos personales si así lo exige la ley o en respuesta a solicitudes válidas de las autoridades públicas (p. ej., un tribunal o una agencia gubernamental).</p>
                        ...
                        <ul>
                        <li>Por correo electrónico: mediatec68@gmail.com</li>
            </ul>
                    </div>
                </div>
            </section>        
...
<?php /**PATH C:\laragon\www\MediaTec\resources\views/MediaTec/politicas.blade.php ENDPATH**/ ?>