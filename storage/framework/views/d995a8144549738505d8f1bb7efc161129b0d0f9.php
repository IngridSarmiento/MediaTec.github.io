                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <article class="post-grid mb-5 ">
                                        <a class="post-thumb mb-4 d-block" href="/nota/<?php echo e($publicacion->id); ?>">
                                            ...
                                            case ("imagen"): ?>
                                                <img class="img-fluid mx-auto mb-4" src="<?php echo e(asset($publicacion->multimedias->where('principal', '1')->first()->ruta)); ?>" style="width: 400px; height: 300px;">
                                                <?php break; ?>
                                            <?php case ("video"): ?>
                                                <video src="<?php echo e(asset($publicacion->multimedias->where('principal', '1')->first()->ruta)); ?>" width="300" height="300"></video>
                                                <?php break; ?>
                                            <?php case ("audio"): ?>
                                                <audio src="<?php echo e(asset($publicacion->multimedias->where('principal', '1')->first()->ruta)); ?>" width="500" height="500" controls></audio>
                                                <?php break; ?>
                                            <?php case ("documento"): ?>
                                                <img class="img-fluid mx-auto mb-4" src="<?php echo e(asset('multimedia/pdf-icon.png')); ?>" style="width: 300px; height: 300px;">
                                                <?php break; ?>
                                        <?php endswitch; ?>    
                                        </a>
                                        <br>
...
<?php echo $__env->make('MediaTec.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\MediaTec\resources\views/MediaTec/publicaciones.blade.php ENDPATH**/ ?>