<?php echo $__env->make('MediaTec.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <header class="cabecera_xs" style=" background-image: url(<?php echo e(asset('mediatec/assets/img/terminos-fondo.jpg')); ?>">
        </header> 
            <section class="contacto pt-5" id="colecciones">
                <div class="container">
                    <div class="container-xxl">
                        <div class="container" align="center">
                            <h1 class="mb-4">TÉRMINOS Y CONDICIONES DE USO GENERALES PARA LA PLATAFORMA DIGITAL MEDIATEC</h1>
                        </div>
                    </div>
                    <br>
                    <div class="container">
                        <div data-v-11b4eedd="" data-v-164ff72a="" class="results__agreement-preview" align="justify">
                            <h4> Términos y condiciones </h4> 
                            <p> ¡Bienvenido a MEDIATEC! </p> 
                            <p> Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web MEDIATEC, perteneciente a los dominios del TECNM.</p> 
                            <p> Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando MEDIATEC si no estás de acuerdo con todos los términos y condiciones establecidos en esta página. </p> 
                            <h4> Cookies: </h4> 
                            <p> El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a MEDIATEC, aceptaste utilizar las cookies necesarias. </p> 
                            ...
                            <h4> Licencia: </h4> 
                            <p> A menos que se indique lo contrario, TECNM y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en MEDIATEC. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde MEDIATEC para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones. </p> 
                            <p> No debes: </p> 
                            <ul> 
                                <li> Copiar o volver a publicar material de MEDIATEC </li> 
                                <li> Vender, alquilar o sublicenciar material de MEDIATEC </li> 
                                <li> Reproducir, duplicar o copiar material de MEDIATEC </li> 
                                <li> Redistribuir contenido de MEDIATEC </li> 
                            </ul> 
                            <p> Este acuerdo comenzará el fecha presente. </p> 
                            <p> Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. TECNM no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de TECNM, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, TECNM no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados &ZeroWidthSpace;&ZeroWidthSpace;o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web. </p> 
                            <p> TECNM se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones. </p> 
                            ...
                            <ul> 
                                ...
                                <li> Los comentarios no contienen ningún material difamatorio, calumnioso, ofensivo, indecente o ilegal de otro modo, que sea una invasión de la privacidad. </li> <li> Los comentarios no se utilizarán para solicitar o promover negocios o actividades comerciales personalizadas o presentes o actividades ilegales. </li> 
                            </ul> 
                            <p> Por la presente, otorgas a TECNM una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios. </p> 
                            ...
                            <ul> 
                                ...
                                <li> Los distribuidores de directorios en línea pueden vincularse a nuestro sitio web de la misma manera que hacen hipervínculos a los sitios web de otras empresas que figuran en la lista; y </li> <li> Empresas acreditadas en todo el sistema, excepto que soliciten organizaciones sin fines de lucro, centros comerciales de caridad y grupos de recaudación de fondos de caridad que no pueden hacer hipervínculos a nuestro sitio web. </li> </ul> <p> Estas organizaciones pueden enlazar a nuestra página de inicio, a publicaciones o a otra información del sitio siempre que el enlace: (a) no sea engañoso de ninguna manera; (b) no implique falsamente patrocinio, respaldo o aprobación de la parte vinculante y sus productos y/o servicios; y (c) encaja en el contexto del sitio de la parte vinculante. </p> 
                                ...
                                <p> Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a TECNM. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta. </p> 
                                ...
                                <p> No se permitirá el uso del logotipo de TECNM u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial. </p> 
...
<?php /**PATH C:\laragon\www\MediaTec\resources\views/MediaTec/terminos.blade.php ENDPATH**/ ?>