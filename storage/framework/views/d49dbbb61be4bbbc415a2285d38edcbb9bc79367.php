        ...
        <div class="col-60 col-sm-8 col-md-100 col-lg-100 col-xl-90">
            <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <p align="center"><h3>Editar Subcategoria</h3></p>
                </div>
                <form action="/editar-subcategoria/<?php echo e($subcategoria->id); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre</label>
                        <input type="text" name="nombre" value="<?php echo e($subcategoria->nombre); ?>" class="form-control" id="exampleInputEmail1">
                    </div>
                    <div class="mb-3">                                
...
<?php echo $__env->make('Administrador.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <?php /**PATH C:\laragon\www\MediaTec\resources\views/Administrador/editarsubcategoria.blade.php ENDPATH**/ ?>