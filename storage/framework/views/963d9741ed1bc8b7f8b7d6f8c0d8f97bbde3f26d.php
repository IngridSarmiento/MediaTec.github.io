                    ...
                    <div class="row">                        
                        <div class="col-lg-3 col-sm-6">
                            <div class="single-post-wrap style-white">
                                <a href="/explorar/imagen" class="link-light">
                                <div class="thumb">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="single-post-wrap style-white">
                               <a href="/explorar/video" class="link-light">
                                <div class="thumb">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="single-post-wrap style-white">
                               <a href="/explorar/audio" class="link-light">
                                <div class="thumb">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="single-post-wrap style-white">
                               <a href="/explorar/documento" class="link-light">
                                <div class="thumb">
...
<?php echo $__env->make('MediaTec.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\MediaTec\resources\views/MediaTec/explorar.blade.php ENDPATH**/ ?>