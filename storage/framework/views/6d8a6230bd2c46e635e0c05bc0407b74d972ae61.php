...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('mediatec/assets/favicon.ico')); ?>" />
        ...
        <link href="<?php echo e(asset('mediatec/css/styles.css')); ?>" rel="stylesheet" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container"> 
                <img src="<?php echo e(asset('mediatec/assets/img/logos/media.png')); ?>" width="125px" height="75px" style="margin-right: 40px">               
        ...
        <header class="cabecera" style=" background-image: url('<?php echo e(asset('mediatec/assets/img/edie.png')); ?>');">
            <br><br><br><br><br>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <center><img src="<?php echo e(asset('mediatec/assets/img/tec.png')); ?>" width="90%" height="60%" > </center>
                    </div>
                    <div class="col-lg-6 col-sm-6"> 
        ...
        <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
            ...
            <script src="<?php echo e(asset('mediatec/js/index.js')); ?>"></script>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-bs-dismiss="modal"><img src="<?php echo e(asset('mediatec/assets/img/close-icon.svg')); ?>" alt="Close modal" /></div>
                <div class="container">
...
<?php /**PATH C:\laragon\www\MediaTec\resources\views/MediaTec/cronologia.blade.php ENDPATH**/ ?>